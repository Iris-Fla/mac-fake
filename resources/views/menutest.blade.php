    ...
    <div class="max-w-md mx-auto bg-white min-h-screen">
        ...
        <header class="px-4 py-3 border-b">
            <div class="flex items-center">
                ...
                <h1 class="ml-2 text-lg font-semibold">中央店で受け取り</h1>
            </div>
        </header>
        ...
        <!-- カートの内容を表示するセクション -->
        <div id="cart-content" class="fixed top-0 right-0 p-4 bg-white border-l h-full overflow-y-auto">
            <h2 class="text-lg font-semibold">カートの中身</h2>
            <ul id="cart-items">
                <!-- カートのアイテムがここに表示されます -->
            </ul>
        </div>
